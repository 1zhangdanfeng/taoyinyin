	...
	<div class="content">
		<div class="dl-main-nav">
			...
			<ul id="J_Nav"  class="nav-list ks-clear">   
                ...
                <li class="nav-item dl-selected"><div class="nav-item-inner nav-order">商户统计</div></li>
			</ul>
		</div>
	...
	<script>
		BUI.use('common/main',function(){
			var config = [ {id:'1',homePage:'2',menu:[{text:'个人管理',items:[{id:'2',text:'个人管理',href:'<?php echo ($config[0]); ?>'}]}]},
						   ...
						   {id:'5',homePage:'6',menu:[{text:'商户统计',items:[{id:'6',text:'订单统计',href:'<?php echo ($config[2]); ?>'}]}]}
						 ];
